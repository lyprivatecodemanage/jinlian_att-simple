...
public class MonthReportServiceImpl implements MonthReportService {
	...
	public ReturnData SelectMonthReportFuzzy(Paging paging) {
		...
		for (ReportDaily reportDaily : list) {
			...
			reportDaily.setLeaveDaysOff(String.valueOf(Math.floor(Integer.parseInt(reportDaily.getAbsentTime())/30)/2));
			reportDaily.setLeaveDaysOff(String.valueOf(Math.floor(Integer.parseInt(reportDaily.getNormalOverWork())/30)/2));
		}
